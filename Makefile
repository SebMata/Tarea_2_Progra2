...
test:
	...
	g++ $(FLAGS) src/empleadoHoras.cpp -o bin/empleadoHoras.o
	g++ $(FLAGS) src/planilla.cpp -o bin/planilla.o
	g++ -g -o bin/tests bin/empleadoHoras_tests.o bin/planilla_tests.o bin/empleadoNominas_tests.o bin/empleado_tests.o bin/empleado.o bin/empleadoNomina.o bin/empleadoHoras.o bin/planilla.o -lgtest -lgtest_main -lpthread 
